...
from seg4to1_dataloader import make_testdatapath_list, DataTransform, MFNetDataset
...
if __name__ == '__main__':  
    ...
    state_dict = torch.load("./checkpoints/seg_101_202502272242/seg_101_100_202502272242.pth", map_location={'cuda:0': 'cpu'}) ## ここを変更
    model.load_state_dict(state_dict)
    print('ネットワーク設定完了：学習済みの重みをロードしました')

    # ディレクトリ作成
    save_dir = f"./output/seg4to1_test_{now1()}"
