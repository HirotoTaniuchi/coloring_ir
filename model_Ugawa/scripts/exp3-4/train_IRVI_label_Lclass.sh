...
MODEL="AAFSTNet2andSegNet2_RGB"    # モデルの名前
NET_D="basic"   # Discriminatorの種類：論文ではbasicしか使用しません
OPTION="_RSGAN_label_Lclass"    # モデルに関する追加情報：チェックポイントを識別するために記載します
STAGE="full"    # 学習時はfull
...
SEG_TO_D_INST="--seg_to_D"     # ラベルマップをクラス画像判別器に入力するか [--seg_to_D_inst]
...
cp scripts/exp3-4/train_IRVI_label_Lclass.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/train_IRVI_label_Lclass.sh
