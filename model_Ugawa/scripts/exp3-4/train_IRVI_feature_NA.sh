...
OPTION="_RSGAN_feature_NA"    # モデルに関する追加情報：チェックポイントを識別するために記載します
STAGE="full"    # 学習時はfull
...
# 重みなど
L1="charbonnier"         # コンテンツ損失として使用するロスの種類：論文は'l1' ['l1', 'charbonnier', 'PatchNCE']
...
cp scripts/exp3-4/train_IRVI_feature_NA.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/train_IRVI_feature_NA.sh
