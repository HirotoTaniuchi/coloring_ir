...
OPTION="_RSGAN_label_NA"     # モデルに関する追加情報：チェックポイントを識別するために記載
...
cp scripts/exp3-4/test_IRVI_label_NA.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_IRVI_label_NA.sh
