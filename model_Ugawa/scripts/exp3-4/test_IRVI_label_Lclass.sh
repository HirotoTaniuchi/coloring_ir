...
GPU_ID=1    # 使用するGPUのID
RESULT_DIR="./results_3-4"   # 結果を保存するディレクトリ 
...
OPTION="_RSGAN_label_Lclass"     # モデルに関する追加情報：チェックポイントを識別するために記載
...
cp scripts/exp3-4/test_IRVI_label_Lclass.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_IRVI_label_Lclass.sh
