...
OPTION="_RSGAN_NA_Lclass"     # モデルに関する追加情報：チェックポイントを識別するために記載
...
cp scripts/exp3-4/test_IRVI_NA_Lclass.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_IRVI_NA_Lclass.sh
