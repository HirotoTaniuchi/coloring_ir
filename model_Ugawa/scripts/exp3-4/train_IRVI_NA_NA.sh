...
OPTION="_RSGAN_NA_NA"    # モデルに関する追加情報：チェックポイントを識別するために記載します
STAGE="full"    # 学習時はfull
...
cp scripts/exp3-4/train_IRVI_NA_NA.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/train_IRVI_NA_NA.sh
