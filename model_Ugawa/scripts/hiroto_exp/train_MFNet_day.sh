...
DATASET_NAME=MFNet_day
DATASET_DIR_A=/home/usrs/taniuchi/workspace/datasets/ir_seg_dataset/images_ir_day
DATASET_DIR_B=/home/usrs/taniuchi/workspace/datasets/ir_seg_dataset/images_rgb_day
...
DATE=2025_11_11    # 実験を開始した日付：年_月_日
MODEL="AAFSTNet2andSegNet2"    # モデルの名前
NET_D="basic"   # Discriminatorの種類：論文ではbasicしか使用しません
OPTION="_RSGAN"    # モデルに関する追加情報：チェックポイントを識別するために記載します
STAGE="full"    # 学習時はfull
...
cp scripts/exp1/train_MFNet_day.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/train_MFNet_day.sh
