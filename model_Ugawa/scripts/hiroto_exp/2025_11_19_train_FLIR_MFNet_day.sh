...
# これからここをどうしていくか
cp scripts/hiroto_exp/2025_11_19_train_FLIR_MFNet_day.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/2025_11_19_train_FLIR_MFNet_day.sh
