...
##############################################################
# パスなど
CHECKPOINT_DIR="./checkpoints"    # チェックポイントを保存したディレクトリ
GPU_ID=0    # 使用するGPUのID
RESULT_DIR="./results_1"   # 結果を保存するディレクトリ 
...
DATASET_NAME=FLIR
DATASET_DIR_A=/home/usrs/ugawa/lab/work/datasets/FLIR_aligned_TICCGAN/JPEGImages/val/A/day
DATASET_DIR_B=/home/usrs/ugawa/lab/work/datasets/FLIR_aligned_TICCGAN/JPEGImages/val/B/day
SEG_CKPT_PATH=/home/usrs/taniuchi/workspace/projects/coloring_ir/checkpoints/2024_8_20_AAFSTNet2andSegNet2_MFNet/AAFSTNet2andSegNet2_MFNet_full_RSGAN/100_net_D.pth
...
cp scripts/exp1/test_FLIR_day.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_FLIR_day.sh
