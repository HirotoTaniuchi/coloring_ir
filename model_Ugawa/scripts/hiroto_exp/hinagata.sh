...
GPU_ID=0    # 使用するGPUのID
## ⭐️ここを変更
RESULT_DIR=/home/usrs/taniuchi/workspace/projects/coloring_ir/output_img/Ugawa_2025_11_20_AAFSTNet2andSegNet2_FLIR_MFNet_day # ⚠️⚠️⚠️⚠️  # 結果を保存するディレクトリ 

# データセットのパス
# DATASET_DIR_AにTIR画像のディレクトリを指定してください
# DATASET_DIR_Bに可視画像のディレクトリを指定してください
# SEG_CKPT_PATHにセグメンテーションモデルのチェックポイントのパスを指定してください
DATASET_NAME=FLIR_MFNet_day # ⚠️⚠️⚠️⚠️
## ⭐️ここを変更 ## *A:TIR, B:RGB
DATASET_DIR_A=/home/usrs/taniuchi/workspace/datasets/ir_seg_dataset/images_ir_str/day/test #⚠️⚠️⚠️⚠️
DATASET_DIR_B=/home/usrs/taniuchi/workspace/datasets/ir_seg_dataset/images_rgb_str/day/test # ⚠️⚠️⚠️⚠️
...
DATE=2025_11_19     # 実験を開始した日付：年_月_日 #⚠️⚠️⚠️⚠️
...
cp scripts/hiroto_exp/2025_11_20_test_FLIR_MFNet_day.sh ${RESULT_DIR}/2025_11_20_test_FLIR_MFNet_day.sh #⚠️⚠️⚠️⚠️
