...
DATE=2024_8_20    # 実験を開始した日付：年_月_日
...
cp scripts/exp1/train_FLIR.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/train_FLIR.sh
