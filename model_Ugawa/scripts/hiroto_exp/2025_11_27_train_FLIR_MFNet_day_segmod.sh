...
DATASET_DIR_A=/home/usrs/ugawa/lab/work/datasets/FLIR_aligned_TICCGAN/JPEGImages/train/A/day
DATASET_DIR_B=/home/usrs/ugawa/lab/work/datasets/FLIR_aligned_TICCGAN/JPEGImages/train/B/day
SEG_CKPT_PATH=/home/usrs/taniuchi/workspace/projects/coloring_ir/segmentation/checkpoints/ver2_ir_3ch_deeplabv3plus_resnet101_2025_11_27/seg_100_100_202511271736.pth

# あとは実行して大丈夫なはずです

DATE=2025_11_27    # 実験を開始した日付：年_月_日
MODEL="AAFSTNet2andSegNet2"    # モデルの名前
NET_D="basic"   # Discriminatorの種類：論文ではbasicしか使用しません
OPTION="segmoduleMFNet"    # モデルに関する追加情報：チェックポイントを識別するために記載します
STAGE="full"    # 学習時はfull
...
SEG_NUM_CLASSES=9  # ラベルマップのクラス数：論文では19(0~19の20クラス)
...
VISDOM_ENV=${DATE}_${MODEL}_${DATASET_NAME}_${OPTION}
VISDOM_PORT=-1  # visdomのポート番号：-1の場合使用しない

mkdir -p ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}_${OPTION}
...
HALF_EPOCH=50  # 総エポック数の1/2を記入してください
