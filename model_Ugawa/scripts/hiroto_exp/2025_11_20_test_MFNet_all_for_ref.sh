...
GPU_ID=0    # 使用するGPUのID
## ⭐️ここを変更
RESULT_DIR=/home/usrs/taniuchi/workspace/projects/coloring_ir/output_img/Ugawa_2025_11_20_AAFSTNet2andSegNet2_MFNet_all_for_ref  # 結果を保存するディレクトリ 
...
cp scripts/hiroto_exp/2025_11_20_test_MFNet_all_for_ref.sh ${RESULT_DIR}/2025_11_20_test_MFNet_all_for_ref.sh
