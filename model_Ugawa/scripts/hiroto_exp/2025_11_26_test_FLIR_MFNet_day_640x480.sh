...
GPU_ID=0    # 使用するGPUのID
## ⭐️ここを変更
RESULT_DIR=/home/usrs/taniuchi/workspace/projects/coloring_ir/output_img/Ugawa_2025_11_26_AAFSTNet2andSegNet2_FLIR_MFNet_day_640x480  # 結果を保存するディレクトリ 
...
## ⭐️ここを変更 ## *A:TIR, B:RGB
DATASET_DIR_A=/home/usrs/taniuchi/workspace/datasets/ir_seg_dataset/images_ir_str/day/test
DATASET_DIR_B=/home/usrs/taniuchi/workspace/datasets/ir_seg_dataset/images_rgb_str/day/test
...
DATE=2025_11_26     # 実験を開始した日付：年_月_日⭐️
MODEL="AAFSTNet2andSegNet2"     # モデルの名前
OPTION="640x480"     # モデルに関する追加情報：チェックポイントを識別するために記載⭐️
