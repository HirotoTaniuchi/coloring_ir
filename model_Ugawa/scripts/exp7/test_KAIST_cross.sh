...
GPU_ID=1    # 使用するGPUのID
RESULT_DIR="./results_7"   # 結果を保存するディレクトリ 
...
cp scripts/exp7/test_KAIST_cross.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_KAIST_cross.sh
