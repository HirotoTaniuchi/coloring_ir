...
GPU_ID=1    # 使用するGPUのID
RESULT_DIR="./results_5"   # 結果を保存するディレクトリ 
...
OPTION="_RSGAN_Lclass0.003"     # モデルに関する追加情報：チェックポイントを識別するために記載
...
cp scripts/exp5/test_IRVI_Lclass0.003.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_IRVI_Lclass0.003.sh
