...
GPU_ID=1    # 使用するGPUのID
RESULT_DIR="./results_6"   # 結果を保存するディレクトリ 
...
OPTION="_LSGAN"     # モデルに関する追加情報：チェックポイントを識別するために記載
...
cp scripts/exp6/test_IRVI_LSGAN.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_IRVI_LSGAN.sh
