...
OPTION="_SGAN"    # モデルに関する追加情報：チェックポイントを識別するために記載します
STAGE="full"    # 学習時はfull
...
# フラグ類
GAN_TYPE="SGAN"                    # 敵対的損失の種類：論文ではRSGAN [RSGAN, SGAN, LSGAN]
...
cp scripts/exp6/train_IRVI_SGAN.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/train_IRVI_SGAN.sh
