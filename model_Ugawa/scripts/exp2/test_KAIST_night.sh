...
GPU_ID=1    # 使用するGPUのID
RESULT_DIR="./results_2"   # 結果を保存するディレクトリ 

# データセット関連
DATASET_NAME=KAIST
DATASET_DIR_A=/home/usrs/ugawa/lab/work/datasets/kaist-cvpr15_TICCGAN/copy/test_night/testA
DATASET_DIR_B=/home/usrs/ugawa/lab/work/datasets/kaist-cvpr15_TICCGAN/copy/test_night/testB
...
cp scripts/exp2/test_KAIST_night.sh ${RESULT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_KAIST_night.sh
