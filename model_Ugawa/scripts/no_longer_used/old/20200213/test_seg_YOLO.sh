...
DATASET_DIR_B=${HOME}/lab/work/datasets/FLIR_ADAS_1_3/val/thermal_8_bit
...
cp test_seg_YOLO.sh $RESULT_DIR/${DATE}_${MODEL}_${DATASET_NAME}_${SEG_MODEL}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/test_seg.sh
