...
SEG_DIR=/home/usrs/ugawa/lab/work/datasets/FLIR_aligned_TICCGAN/JPEGImages/train_val/B/day_segmentation/resnet101/segmentation
...
MODEL="AAFSTNet2Seg"
STAGE="full"
OPTION="_RSGAN_RGB_seg0_concat"
GAN_TYPE="RSGAN"
RESULT_DIR="./results_val"
EPOCH="200"
CLAHE="" # --clahe
A_INVERT="" #--A_invert
