...
SEG_CKPT_PATH=./checkpoints_segmentation/KAIST_finetune/latest_deeplabv3plus_resnet101_cityscapes_os16.pth
...
cp scripts/exp1/train_KAIST.sh ${CHECKPOINT_DIR}/${DATE}_${MODEL}_${DATASET_NAME}/${MODEL}_${DATASET_NAME}_${STAGE}${OPTION}/train_KAIST.sh
