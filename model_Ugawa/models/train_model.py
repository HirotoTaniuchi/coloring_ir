...
class TrainModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.optimizers = []
        if opt.stage == 'full' or opt.stage == 'instance' or opt.stage == 'full_tir':
            self.model_names = ['G']
            ...
            raise NotImplementedError(f"Selected stage is not implemented")
    ...
    def set_input(self, input, gt_data=None, opt=None):
    ...
    def forward(self):
        if self.opt.stage == 'full' or self.opt.stage == 'instance' or self.opt.stage == 'full_tir':
