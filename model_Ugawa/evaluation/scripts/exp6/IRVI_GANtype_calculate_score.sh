...
SAVE_DIR=./exp6/IRVI_scores/GANtype
...
EXP_NAME=AAFSTNet2andSegNet2_IRVI_Traffic_full_SGAN-test_other_latest
# FAKE_DIRには生成画像が入っているディレクトリのパスを指定してください
FAKE_DIR=../results_6/2024_2_15_AAFSTNet2andSegNet2_IRVI_Traffic/AAFSTNet2andSegNet2_IRVI_Traffic_full_SGAN/test_other_latest/fake_B
...
# LSGAN
EXP_NAME=AAFSTNet2andSegNet2_IRVI_Traffic_full_LSGAN.3-test_other_latest
FAKE_DIR=../results_6/2024_2_15_AAFSTNet2andSegNet2_IRVI_Traffic/AAFSTNet2andSegNet2_IRVI_Traffic_full_LSGAN/test_other_latest/fake_B
python calculate_score.py --real_dir $REAL_DIR --fake_dir $FAKE_DIR --save_dir $SAVE_DIR --fid_real_dir $FID_REAL_DIR --exp_name $EXP_NAME --gpu_id $GPU_ID --fid_dim $FID_DIM --pixel_wise_metrics
