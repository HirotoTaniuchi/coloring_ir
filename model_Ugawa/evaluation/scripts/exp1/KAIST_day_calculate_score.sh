...
FAKE_DIR=../results_1/2024_2_15_AAFSTNet2andSegNet2_KAIST/AAFSTNet2andSegNet2_KAIST_full_RSGAN/test_day_latest/fake_B
REAL_DIR=../real_images/KAIST_256x256/day/real_B
FID_REAL_DIR=../real_images/KAIST_256x256/day/real_B
SAVE_DIR=./exp1/KAIST_scores/day

# EXP_NAMEはSAVE_DIR以下に作成されるディレクトリとcsv,txtファイルの名前になります。モデル名+実験条件などが良いと思います
# GPU_IDは計算に使用するGPUのIDを指定してください
EXP_NAME=AAFSTNet2andSegNet2_KAIST_full_RSGAN-test_day_latest
GPU_ID=0
