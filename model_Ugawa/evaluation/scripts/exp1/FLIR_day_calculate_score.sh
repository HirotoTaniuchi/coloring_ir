...
FAKE_DIR=../results_1/2024_2_15_AAFSTNet2andSegNet2_FLIR/AAFSTNet2andSegNet2_FLIR_full_RSGAN/test_day_latest/fake_B
...
SAVE_DIR=./exp1/FLIR_scores/day

# EXP_NAMEはSAVE_DIR以下に作成されるディレクトリとcsv,txtファイルの名前になります。モデル名+実験条件などが良いと思います
# GPU_IDは計算に使用するGPUのIDを指定してください
EXP_NAME=AAFSTNet2andSegNet2_FLIR_full_RSGAN-test_day_latest
GPU_ID=1

# FID_DIMにはFIDの計算に使用する次元数を指定してください(FLIR昼間の場合は192)
FID_DIM=192
